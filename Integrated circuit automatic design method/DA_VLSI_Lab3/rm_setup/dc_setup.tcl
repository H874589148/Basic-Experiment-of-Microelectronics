...
#set RTL_SOURCE_FILES  "full_adder.v"      ;# Enter the list of source RTL files if reading from RTL
set RTL_SOURCE_FILES  "gcd_rtl_2009.v"      ;# Enter the list of source RTL files if reading from RTL
