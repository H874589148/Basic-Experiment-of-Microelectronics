...
set DESIGN_REF_DATA_PATH          "[pwd]"  ;#  Absolute path prefix variable for library/design data.
...
set MIN_LIBRARY_FILES             "saed32nm_max_0d95_125.db saed32nm_min_0d95_125.db"  ;#  List of max min library pairs "max1 min1 max2 min2 max3 min3"...

#set MW_REFERENCE_LIB_DIRS         ""  ;#  Milkyway reference libraries (include IC Compiler ILMs here)
set MW_REFERENCE_LIB_DIRS  " \
	${DESIGN_REF_NLDMA_PATH}/milkyway/saed32nm_rvt_1p9m/FRAM \
	${DESIGN_REF_NLDMB_PATH}/milkyway/saed32nm_lvt_1p9m/FRAM \
	${DESIGN_REF_NLDMC_PATH}/milkyway/saed32nm_hvt_1p9m/FRAM \
	"
