...
if {![file exists [which $PT_DIR/pt_shell]]} {
  echo "RM-Info : $PT_DIR/pt_shell does not exist. check_signoff_correlation is skipped as $PT_DIR/pt_shell does not exist."
...
check_signoff_correlation -preroute -pt_only
}
