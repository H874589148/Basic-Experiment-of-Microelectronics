...
# Read in the complete mapped design even for a top-only verification.
# This is required to get the correct hierarchical design port interface definitions.
#################################################################################

# For Verilog
# foreach design ${HIERARCHICAL_DESIGNS} {
# read_verilog -i ${design}.mapped.v
# }
