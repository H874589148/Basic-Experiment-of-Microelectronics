...
print OUT "\n";
print OUT "<b>2.Steps in explore mode and corresponding outputs:</b>\n";
...
print OUT "<b>  how to use the results and proceed with ICC-RM?</b>\n";
print OUT " \n";
print OUT "  After the explore mode is completed, please review results in the HTML table - ${DESIGN_NAME}_explore.html, and\n";
print OUT "  choose one result to proceed with ICC-RM.\n";
print OUT "  You can do so by either of the following two approachs depending on your preference :\n";
print OUT " \n";
print OUT "  - Use the saved CEL from the run you choose as the starting point for ICC RM\n";
print OUT "    -> Please specify the varible ICC_FLOORPLAN_CEL in icc_setup.tcl with this CEL name.\n";
...
print OUT "     * ICC_FLOORPLAN_CEL is the variable which you specify as the starting CEL for ICC-RM.\n";
print OUT " \n";
print OUT "  - Use the written-out floorplan and route files from the run you choose and load them onto the original CEL\n";
print OUT "    -> Open CEL saved_cel_before_explore_mode, load the written-out floorplan and route files.\n";
print OUT "    -> save the CEL as a differnt name, such as, flat_dp, and specify ICC_FLOORPLAN_CEL with this CEL name. Then ICC-RM will start with this CEL.\n";
print OUT "     * This approach ensures no netlist change but only macro placement and PG routes from the explore mode.\n";
print OUT "     * saved_cel_before_explore_mode is the CEL saved before explore mode starts which is your clean starting point\n";
print OUT "     * the written-out floorplan file is in \$RESULTS_DIR which you can load by using the following command :\n";
print OUT "    		read_floorplan \$RESULTS_DIR/run0_default_dump.floorplan\n";
print OUT "     * the written-out route file is in \$RESULTS_DIR which you can load by using the following command :\n";
