...
# U ipo ahfs			off	<on,off>   allow ahfs buffer removal and change of high fanout threshold
# V ipo ahfs remove effort	none	<none,medium,high> (set_ahfs_options -remove_effort $ipo_ahfs_remove_effort)
...
dp_explore run0 default                        auto low  on  off off off 100 low off "" "" automatic 10 low 1 1 on high off none medium off off
dp_explore run1 default+moe_off+cong            off low  on  on  off off 100 low off "" "" automatic 10 low 1 1 on high off none medium off off
dp_explore run2 default+moe_off+cong+timing     off low  on  on  on  off 100 low off "" "" automatic 10 low 1 1 on high off none medium off off
dp_explore run3 default+moe_on                  on  low  on  off off off 100 low off "" "" automatic 10 low 1 1 on high off none medium off off
dp_explore run4 default+moe_on+timing           on  low  on  off on  off 100 low off "" "" automatic 10 low 1 1 on high off none medium off off
dp_explore run5 default+moe_on+cong+timing      on  low  on  on  on  off 100 low off "" "" automatic 10 low 1 1 on high off none medium off off
dp_explore run6 default+hier_off+moe_off        off low  off off off off 100 low off "" "" automatic 10 low 1 1 on high off none medium off off
dp_explore run7 default+hier_off+moe_off+cong   off low  off on  off off 100 low off "" "" automatic 10 low 1 1 on high off none medium off off
dp_explore run8 default+hier_off+moe_on+group   on  high off off off off 100 low off "" "" automatic 10 low 1 1 on high off none medium off off
#dp_explore run9 default+high_effort_ipo        off low  on  off off on  40  low off "" "" automatic 10 low 1 1 on high on  high medium on  off
#moe: macros on edge
